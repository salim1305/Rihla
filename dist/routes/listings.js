...
router.post("/", authMiddleware_1.authenticate, uploadMiddleware_1.upload.array('photos'), (0, validate_1.validateBody)(listingValidator_1.listingSchema), listingController_1.createListing);
